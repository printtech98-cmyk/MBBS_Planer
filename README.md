...
Add your screenshots to a /screenshots folder in this repo, then they'll render below on GitHub automatically. Suggested shots (see the "How to get clean screenshots" note underneath):
